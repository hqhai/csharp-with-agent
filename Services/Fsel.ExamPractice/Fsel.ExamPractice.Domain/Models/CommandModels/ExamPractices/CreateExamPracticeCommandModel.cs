...
namespace Fsel.ExamPractice.Domain.Models.CommandModels.ExamPractices
{
    ...
    public class CreateExamPracticeCommandModel
    {
        ...
        public IList<CreateExamPracticeSectionCommandModel> ExamPracticeSections { get; set; } = new List<CreateExamPracticeSectionCommandModel>();
    }
}

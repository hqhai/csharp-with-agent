...
namespace Fsel.ExamPractice.Infrastructure.Common
{
    ...
    public static class LinQAnswerHelper
    {
        public static bool IsNullOrEmptyData(object? data, string? nameProperty = default, bool isLoop = true)
        {
        ...
        public static bool IsAnswerHaveData(object? data, string? nameProperty = default)
        {
            if (data is IList list)
            {
                var objects = list.Cast<object>().ToList();
        ...
        public static bool IsDuplicateAnswerId(object? data, string? nameProperty = default)
        {
            if (data is IList list)
            {
                var objects = list.Cast<object>().ToList();
        ...
        public static bool? IsWordMatchAtIndex(IList<string>? words, string? word, int index = 0)
        {
        ...
        public static bool? CheckAnswer(IList<string>? words, string? word, int index = default)
        {
        ...
        public static bool CheckAnswer(string? content, string? word)
        {
        ...
        public static bool IsShortAnswer(string? question, string? answer)
        {
        ...
        public static bool IsQuestionContainedInAnswer(string? question, string? answer)
        {

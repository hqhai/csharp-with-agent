...
namespace Fsel.Realtime.Application.Hubs
{
    ...
    public class ExamPracticeSpeakingHub : BaseHub
    {
        public ExamPracticeSpeakingHub(AuthContext authContext, IIpApiService ipApiService, IHttpContextAccessor httpContextAccessor) : base(authContext, ipApiService, httpContextAccessor)
        {
        }

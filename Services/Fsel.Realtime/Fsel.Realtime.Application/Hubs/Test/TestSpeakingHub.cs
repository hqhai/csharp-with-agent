...
namespace Fsel.Realtime.Application.Hubs.Test
{
    ...
    public class TestSpeakingHub : BaseHub
    {
        public TestSpeakingHub(AuthContext authContext, IIpApiService ipApiService, IHttpContextAccessor httpContextAccessor) : base(authContext, ipApiService, httpContextAccessor)
        {
        }

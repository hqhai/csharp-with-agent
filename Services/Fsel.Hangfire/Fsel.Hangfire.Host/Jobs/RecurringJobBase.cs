...
namespace Fsel.Hangfire.Host.Jobs
{
    ...
    public static class RecurringJobBase
    {
        public static void Setup()
        {
            ...
            JobExtensions.SetRecurringJob<NotificationLessonCourseTargetWorker>(WorkerSettings.JobName.NotificationLessonCourseTarget, Cron.Weekly(DayOfWeek.Monday, 8, 0), EnumCountryKey.Vietnam.FindSystemTimeZoneInfo());

...
namespace Fsel.Hangfire.Host.Jobs
{
    ...
    public static class RecurringJobBase
    {
        public static void Setup()
        {
            ...
            JobExtensions.SetRecurringJob<TreasureZMatterWorker>(WorkerSettings.JobName.TreasureZMatter, Cron.Weekly(DayOfWeek.Wednesday, 15,45));
            JobExtensions.SetRecurringJob<EnergyOfPlanetWorker>(WorkerSettings.JobName.EnergyOfPlanet, Cron.Weekly(DayOfWeek.Wednesday, 15,45));

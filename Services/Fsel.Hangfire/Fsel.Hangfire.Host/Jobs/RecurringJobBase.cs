...
namespace Fsel.Hangfire.Host.Jobs
{
    ...
    public static class RecurringJobBase
    {
        public static void Setup()
        {
            ...
            //JobExtensions.SetRecurringJob<WeeklyReportWorker>(WorkerSettings.JobName.SendWeeklyReport, Cron.Weekly(DayOfWeek.Monday, 2, 0));
            JobExtensions.SetRecurringJob<WeeklySnapShotLeaderBoardWorker>(WorkerSettings.JobName.AggregateDataWeeklyReport, Cron.Weekly(DayOfWeek.Sunday, 17, 0));

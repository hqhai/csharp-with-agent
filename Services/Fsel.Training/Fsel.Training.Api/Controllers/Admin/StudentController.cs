...
namespace Fsel.Training.Api.Controllers.Admin
{
    ...
    using Fsel.Training.Application.Commands.StudentCmd;
    using MediatR;
    ...
    public class StudentController : ControllerBase
    {
        ...
        {
            MethodResult<bool> commandResult = await _mediator.Send(new DeleteStudentCommand { UserId = id }).ConfigureAwait(false);

...
namespace Fsel.Training.Application.Queries.ClassLiveWorkFlowQuery
{
    ...
    public class SearchAlternativeCalendarsByTeacherQuery : BaseQueryModel, IRequest<MethodResult<PagingItemsModel<AlternativeCalendarModel>>>
    {
    }
    ...
    public class SearchAlternativeCalendarsByTeacherQueryHandler : IRequestHandler<SearchAlternativeCalendarsByTeacherQuery, MethodResult<PagingItemsModel<AlternativeCalendarModel>>>
    {
        ...
        public SearchAlternativeCalendarsByTeacherQueryHandler(IClassLiveWorkFlowRepository classLiveWorkFlowRepository, ISystemService systemService, IUserService userService)
        {
        ...
        public async Task<MethodResult<PagingItemsModel<AlternativeCalendarModel>>> Handle(SearchAlternativeCalendarsByTeacherQuery request, CancellationToken cancellationToken)
        {
            ...
            var classLiveWorkFlows = _classLiveWorkFlowRepository.Queryable

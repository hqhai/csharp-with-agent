...
builder.Services.AddScoped<IAiModelManagerRepository, AiModelManagerRepository>();
builder.Services.AddScoped<IAiModelFeatureRepository, AiFeatureConfigRepository>();

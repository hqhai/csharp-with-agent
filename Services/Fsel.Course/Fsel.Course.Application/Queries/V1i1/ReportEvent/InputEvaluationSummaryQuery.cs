...
namespace Fsel.Course.Application.Queries.V1i1.ReportEvent
{
    ...
    public class InputEvaluationSummaryQuery : IRequest<MethodResult<IList<TotalEvaluateInputResultModel>>>
    {
    ...
    public class InputEvaluationSummaryQueryHandler : IRequestHandler<InputEvaluationSummaryQuery, MethodResult<IList<TotalEvaluateInputResultModel>>>
    {
        ...
        public InputEvaluationSummaryQueryHandler(CourseDbContext courseDbContext,
        ...
        public async Task<MethodResult<IList<TotalEvaluateInputResultModel>>> Handle(InputEvaluationSummaryQuery request, CancellationToken cancellationToken)
        {
            ...
            var total = await _courseDbContext.Set<TotalEvaluateInputResultModel>()
                                              .FromSqlRaw("EXEC InputEvaluationSummary @UserId, @DistrictIds, @GradeLevel, @SchoolIds, @TargetGroup, @Date",

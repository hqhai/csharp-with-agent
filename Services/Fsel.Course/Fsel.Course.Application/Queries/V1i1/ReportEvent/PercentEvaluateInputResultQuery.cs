...
namespace Fsel.Course.Application.Queries.V1i1.ReportEvent
{
    ...
    public class PercentEvaluateInputResultQuery : IRequest<MethodResult<IList<PercentEvaluateInputResultModel>>>
    {
    ...
    public class PercentEvaluateInputResultQueryHandler : IRequestHandler<PercentEvaluateInputResultQuery, MethodResult<IList<PercentEvaluateInputResultModel>>>
    {
        ...
        public async Task<MethodResult<IList<PercentEvaluateInputResultModel>>> Handle(PercentEvaluateInputResultQuery request, CancellationToken cancellationToken)
        {
            ...
            var keyCache = $"PercentEvaluateInputResults_{ConvertHelper.Serialize(request)}";
            ...
            var percent = await _courseDbContext.Database.SqlQueryRaw<PercentEvaluateInputResultModel>("EXEC PercentEvaluateInputResults @Target, @GroupByType, @DistrictIds, @GroupIds, @SchoolIds, @Date",

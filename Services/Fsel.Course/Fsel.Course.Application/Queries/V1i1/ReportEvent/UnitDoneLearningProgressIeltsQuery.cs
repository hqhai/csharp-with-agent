...
namespace Fsel.Course.Application.Queries.V1i1.ReportEvent
{
    ...
    public class UnitDoneLearningProgressIeltsQuery : IRequest<MethodResult<IList<UnitDoneLearningProgressIeltsModel>>>
    {
    ...
    public class UnitDoneLearningProgressIeltsQueryHandler : IRequestHandler<UnitDoneLearningProgressIeltsQuery, MethodResult<IList<UnitDoneLearningProgressIeltsModel>>>
    {
        ...
        public async Task<MethodResult<IList<UnitDoneLearningProgressIeltsModel>>> Handle(UnitDoneLearningProgressIeltsQuery request, CancellationToken cancellationToken)
        {
            ...
            var unitDoneIelts = await _courseDbContext.Database.SqlQueryRaw<UnitDoneLearningProgressIeltsModel>("EXEC UnitDoneLearningProgressIelts @Target, @GroupByType, @DistrictIds, @GroupIds, @SchoolIds, @Date",

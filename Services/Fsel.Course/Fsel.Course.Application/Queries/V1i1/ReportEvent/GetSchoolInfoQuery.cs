...
namespace Fsel.Course.Application.Queries.V1i1.ReportEvent
{
    ...
    public class GetSchoolInfoQueryHandler : IRequestHandler<GetSchoolInfoQuery, MethodResult<IList<SchoolInfoModel>>>
    {
        ...
        public GetSchoolInfoQueryHandler(CourseDbContext courseDbContext, AuthContext authContext)
        {
        ...
        public async Task<MethodResult<IList<SchoolInfoModel>>> Handle(GetSchoolInfoQuery request, CancellationToken cancellationToken)
        {
            ...
            var schoolInfos = await _courseDbContext.Database.SqlQueryRaw<SchoolInfoModel>("EXEC SchoolInfoQuery @Type, @GroupIds, @DistrictIds, @Level",

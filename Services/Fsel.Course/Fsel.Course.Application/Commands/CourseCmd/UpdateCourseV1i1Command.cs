...
{
    public class UpdateCourseV1i1Command : UpdateCourseCommandModel, IRequest<MethodResult<CourseModel>>
    {
    }

    public class UpdateCourseV1i1CommandHandler : IRequestHandler<UpdateCourseV1i1Command, MethodResult<CourseModel>>
    {
        ...
        public UpdateCourseV1i1CommandHandler(ICourseRepository courseRepository
            , IMapper mapper
        ...
        public async Task<MethodResult<CourseModel>> Handle(UpdateCourseV1i1Command request, CancellationToken cancellationToken)
        {

...
namespace Fsel.Course.Lms.Application.Queues.Consumers
{
    ...
    public class UpdateOcCheckInClassForumResultConsumer : BaseConsumer<BaseQueueModel>
    {
        ...
        public UpdateOcCheckInClassForumResultConsumer(IMediator mediator, AuthContext authContext) : base(authContext)
        {
            _mediator = mediator;
        }

        public override async Task ConsumeQueue(ConsumeContext<Core.Base.BaseModels.BaseQueueDataModel<BaseQueueModel>> context)
        {

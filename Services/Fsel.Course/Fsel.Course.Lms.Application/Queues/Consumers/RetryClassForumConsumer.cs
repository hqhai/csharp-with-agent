...
namespace Fsel.Course.Lms.Application.Queues.Consumers
{
    ...
    public class RetryClassForumConsumer : BaseConsumer<SetTimeRetryClassForumModel>
    {
        ...
        public RetryClassForumConsumer(IMediator mediator, AuthContext authContext, Microsoft.AspNetCore.Http.IHttpContextAccessor httpContextAccessor) : base(authContext,
            httpContextAccessor)
        {
            _mediator = mediator;
        }

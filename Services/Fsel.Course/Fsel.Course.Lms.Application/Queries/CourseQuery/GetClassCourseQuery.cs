...
//            var classContents = await _trainingService.GetClassListStatusNew();
...
//            var courseClassStudents = await _courseClassStudentRepository.Queryable
//                                            .Where(x => x.CourseId == course.Id && classIds == null || classIds!.Count == 0 || classIds.Contains(x.ClassId))

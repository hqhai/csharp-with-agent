...
namespace Fsel.Course.Lms.Application.Queries.ProgressQuery.V1i2.Overall
{
    ...
    public class GetOverallScoreByLessonQueryHandler : IRequestHandler<GetOverallScoreByLessonQuery, MethodResult<OverallScoreReportModel>>
    {
        ...
        public GetOverallScoreByLessonQueryHandler(
        ...
        public async Task<MethodResult<OverallScoreReportModel>> Handle(GetOverallScoreByLessonQuery request, CancellationToken cancellationToken)
        {
            ...
            var skillScores = await _videoTimeCodeRepository.GetSkillScoresAsync(videoCases, EnumTimeCodeType.Standalone);
            var skillScoreResults = await _videoTimeCodeResultRepository.GetSkillScoreResultsAsync(request.CourseId, student.Id, EnumTimeCodeType.Standalone);

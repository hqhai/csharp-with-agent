...
namespace Fsel.Course.Lms.Application.Queries.ManageProgressQuery
{
    ...
    public class GetManageStudentProgressUnitQuery : IRequest<MethodResult<CourseProgressModel>>
    {
    ...
    public class GetManageStudentProgressUnitQueryHandler : IRequestHandler<GetManageStudentProgressUnitQuery, MethodResult<CourseProgressModel>>
    {
        ...
        public GetManageStudentProgressUnitQueryHandler(IUserService userService, ISystemService systemService, IOrderService orderService, ICourseResultRepository courseResultRepository, ICourseRepository courseRepository, ITrainingService trainingService)
        {
        ...
        public async Task<MethodResult<CourseProgressModel>> Handle(GetManageStudentProgressUnitQuery request, CancellationToken cancellationToken)
        {

...
namespace Fsel.Course.Lms.Application.Services.SystemService
{
    ...
    public interface ISystemService
    {
        ...
        Task<IApiResponse<MethodResult<FeatureAccessTimeModel>>> SaveFeatureAccessTimesAsync([FromBody] SaveFeatureAccessTimeCommandModel command);
    }
}

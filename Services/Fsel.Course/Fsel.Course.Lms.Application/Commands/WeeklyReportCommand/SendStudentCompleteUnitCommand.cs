...
namespace Fsel.Course.Lms.Application.Queries.WeeklyReportQuery
{
    ...
    public class SendStudentCompleteUnitCommandHandler : IRequestHandler<SendStudentCompleteUnitCommand, MethodResult<bool>>
    {
        ...
        public SendStudentCompleteUnitCommandHandler(BaseInternalUnitResultEventHandler baseInternalUnitResult, ILessonResultRepository lessonResultRepository, IUnitRepository unitRepository)
        {

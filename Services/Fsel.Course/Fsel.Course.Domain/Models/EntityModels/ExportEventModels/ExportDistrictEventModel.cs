...
namespace Fsel.Course.Domain.Models.EntityModels.ExportEventModels
{
    ...
    [Keyless]
    public class ExportDistrictEventModel
    {
    ...
    public class ExportDistrictModel
    {
        public string? LocationName { get; set; }
        public IList<ExportSchoolEventModel> ExportSchoolEvents { get; set; } = new List<ExportSchoolEventModel>();
        public IList<ExportStudentEventModel> ExportStudentEvents { get; set; } = new List<ExportStudentEventModel>();
    }
}

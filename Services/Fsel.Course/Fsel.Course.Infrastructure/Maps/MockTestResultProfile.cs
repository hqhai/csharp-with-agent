    ...
    public class MockTestResultProfile : Profile
    {
        public MockTestResultProfile()
        {
            CreateMap<MockTestResult, MockTestResultModel>()
                ...
                .ForMember(x => x.Scores, p => p.MapFrom(o => o.SkillScores != null && o.SkillScores.Any() ? NumberHelper.RoundNumberDouble(o.SkillScores.Average(x => x.Scores), false) : default))
            ...
            CreateMap<MockTestResult, TestResultRankingModel>()
                .ForMember(x => x.Score, p => p.MapFrom(o => o.SkillScores != null && o.SkillScores.Any() ? NumberHelper.RoundNumberDouble(o.SkillScores.Average(x => x.Scores), false) : default));

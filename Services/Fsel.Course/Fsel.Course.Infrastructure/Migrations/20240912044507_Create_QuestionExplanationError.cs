    ...
    public partial class Create_QuestionExplanationError : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "QuestionExplanationErrors",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuestionExplanationErrors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QuestionExplanationErrors_Questions_QuestionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuestionExplanationLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QuestionExplanationLogs_Questions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "Questions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionExplanationErrors_QuestionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionExplanationLogs_QuestionId",
                table: "QuestionExplanationLogs",
                column: "QuestionId");
        }

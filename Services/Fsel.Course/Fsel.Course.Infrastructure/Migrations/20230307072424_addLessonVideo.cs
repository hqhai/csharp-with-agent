...
{
    /// <inheritdoc />
    public partial class addLessonVideo : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LessonUnit", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LessonUnit_Lessons_LessonId",
                        column: x => x.LessonId,
                        principalTable: "Lessons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LessonUnit_Units_UnitId",
                        column: x => x.UnitId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LessonUnit_LessonId",
                table: "LessonUnit",
                column: "LessonId");

            migrationBuilder.CreateIndex(
                name: "IX_LessonUnit_UnitId",
                table: "LessonUnit",
                column: "UnitId");

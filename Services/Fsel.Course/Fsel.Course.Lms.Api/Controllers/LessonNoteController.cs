...
namespace Fsel.Course.Lms.Api.Controllers
{
    ...
    [Route(Settings.APIDefaultRoute + "/lessonNote")]
    ...
    public class LessonNoteController : ControllerBase
    {
        ...
        {
            MethodResult<IList<LessonResultModel>> queryResult = await _mediator.Send(new GetNoteQuery { Id = id }).ConfigureAwait(false);

...
namespace Fsel.Identity.Infrastructure
{
    ...
    public class UserBaseDbContext : BaseIdentityDbContext<User, Role, Guid, UserClaimEntity, UserRole, UserLoginEntity, RoleClaimEntity, UserToken>, IDataProtectionKeyContext
    {

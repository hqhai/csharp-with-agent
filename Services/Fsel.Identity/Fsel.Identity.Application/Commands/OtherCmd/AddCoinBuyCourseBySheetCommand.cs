namespace Fsel.Identity.Application.Commands.OtherCmd
{
    ...
    public class AddCoinBuyCourseBySheetCommand : IRequest<MethodResult<bool>>
    {
    ...
    public class AddCoinBuyCourseBySheetCommandHandler : IRequestHandler<AddCoinBuyCourseBySheetCommand, MethodResult<bool>>
    {
        ...
        public async Task<MethodResult<bool>> Handle(AddCoinBuyCourseBySheetCommand request, CancellationToken cancellationToken)
        {
            ArgumentNullException.ThrowIfNull(request);
            var methodResult = new MethodResult<bool>();

            var spreadSheetId = _appSetting.GoogleSheetConfig?.AddCoinBuyCourseSpreadSheetId;

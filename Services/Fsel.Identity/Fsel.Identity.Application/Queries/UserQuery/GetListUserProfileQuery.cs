...
namespace Fsel.Identity.Application.Queries.UserQuery
{
    ...
    public class GetListUserProfileQuery : IRequest<MethodResult<IList<UserProfileModel>>>
    {
        public List<Guid>? UserId { get; set; }
    }

    public class GetListUserProfileQueryHandler : IRequestHandler<GetListUserProfileQuery, MethodResult<IList<UserProfileModel>>>
    {
        private readonly IMapper _mapper;
        private readonly UserManager<User> _userManager;
        private readonly ITrainingService _trainingService;

        public GetListUserProfileQueryHandler(IMapper mapper, UserManager<User> userManager, ITrainingService trainingService)
        {
            _mapper = mapper;
        ...
        public async Task<MethodResult<IList<UserProfileModel>>> Handle(GetListUserProfileQuery request, CancellationToken cancellationToken)
        {
            ArgumentNullException.ThrowIfNull(request);
            MethodResult<IList<UserProfileModel>> methodResult = new MethodResult<IList<UserProfileModel>>();
            ...
            methodResult.Result = _mapper.Map<IList<UserProfileModel>>(userModel);

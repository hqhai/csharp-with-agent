...
namespace Fsel.System.Application.Commands.ErrorReportCmd
{
    ...
    public class UpdateErrorReportStatusCommand : UpdateErrorReportStatusCommandModel, IRequest<MethodResult<ErrorReportModel>>
    {
    }

    public class UpdateErrorReportStatusCommandHandler : IRequestHandler<UpdateErrorReportStatusCommand, MethodResult<ErrorReportModel>>
    {
        private readonly IMapper _mapper;
        private readonly IErrorReportRepository _errorReportRepository;

        public UpdateErrorReportStatusCommandHandler(IMapper mapper, IErrorReportRepository errorReportRepository)
        {
            _mapper = mapper;
            _errorReportRepository = errorReportRepository;
        }

        public async Task<MethodResult<ErrorReportModel>> Handle(UpdateErrorReportStatusCommand request, CancellationToken cancellationToken)
        {

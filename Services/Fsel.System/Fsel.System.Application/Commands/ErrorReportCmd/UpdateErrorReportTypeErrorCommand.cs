...
namespace Fsel.System.Application.Commands.ErrorReportCmd
{
    ...
    public class UpdateErrorReportTypeErrorCommand : UpdateErrorReportTypeErrorCommandModel, IRequest<MethodResult<ErrorReportModel>>
    {
    }

    public class UpdateErrorReportTypeErrorCommandHandler : IRequestHandler<UpdateErrorReportTypeErrorCommand, MethodResult<ErrorReportModel>>
    {
        private readonly IMapper _mapper;
        private readonly IErrorReportRepository _errorReportRepository;

        public UpdateErrorReportTypeErrorCommandHandler(IMapper mapper, IErrorReportRepository errorReportRepository)
        {
            _mapper = mapper;
            _errorReportRepository = errorReportRepository;
        }

        public async Task<MethodResult<ErrorReportModel>> Handle(UpdateErrorReportTypeErrorCommand request, CancellationToken cancellationToken)
        {

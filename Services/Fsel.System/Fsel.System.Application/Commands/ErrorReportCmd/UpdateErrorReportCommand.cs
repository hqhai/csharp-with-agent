...
namespace Fsel.System.Application.Commands.ErrorReportCmd
{
    ...
    public class UpdateErrorReportCommand : UpdateErrorReportCommandModel, IRequest<MethodResult<ErrorReportModel>>
    {
    }

    public class UpdateErrorReportCommandHandler : IRequestHandler<UpdateErrorReportCommand, MethodResult<ErrorReportModel>>
    {
        private readonly IMapper _mapper;
        private readonly IErrorReportRepository _errorReportRepository;

        public UpdateErrorReportCommandHandler(IMapper mapper, IErrorReportRepository errorReportRepository)
        {
            _mapper = mapper;
            _errorReportRepository = errorReportRepository;
        }

        public async Task<MethodResult<ErrorReportModel>> Handle(UpdateErrorReportCommand request, CancellationToken cancellationToken)
        {

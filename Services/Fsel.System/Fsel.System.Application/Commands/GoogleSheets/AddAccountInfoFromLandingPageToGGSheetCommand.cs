...
namespace Fsel.System.Application.Commands.GoogleSheets
{
    ...
    public class AddAccountInfoFromLandingPageToGGSheetCommand : AddContactInfoFromLPFSELToGoogleSheetCommandModel, IRequest<MethodResult<bool>>
    {
    }

    public class AddAccountInfoFromLandingPageToGGSheetCommandHandler : IRequestHandler<AddAccountInfoFromLandingPageToGGSheetCommand, MethodResult<bool>>
    {
        private readonly AppSetting _appSetting;

        public AddAccountInfoFromLandingPageToGGSheetCommandHandler(AppSetting appSetting)
        {
            _appSetting = appSetting;
        }

        public async Task<MethodResult<bool>> Handle(AddAccountInfoFromLandingPageToGGSheetCommand request, CancellationToken cancellationToken)
        {

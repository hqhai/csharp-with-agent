...
namespace Fsel.System.Infrastructure.Repositories.BlindBoxes
{
    ...
    {
        public BlindBoxChestConfigRepository(SystemDbContext dbContext, SystemReadDbContext readDbContext, AuthContext authContext, AutoMapper.IMapper mapper) : base(dbContext, readDbContext, authContext, mapper)
        {
        }
    }
}
